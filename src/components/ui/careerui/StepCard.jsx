...
export default function StepCard({ step, title, description }) {
  return (
    <div className="text-center bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 rounded-2xl p-6 shadow-md transition-transform duration-300 hover:scale-105 animate-fade-in">
